 ...
 * --------------------------------------
 * Nombre del archivo: InconsistenciaCampoTurnoDTO.java
 * Paquete del archivo: co.gov.supernotariado.bachue.calidaddatos.dto
 * Nombre del elemento: InconsistenciaCampoTurnoDTO
 ...
 * @version 1.0
 */
public class InconsistenciaCampoTurnoDTO {
	// --- Atributos
	/**
	...
	/**
	 * Construye una nueva instancia/objeto de la clase InconsistenciaCampoTurnoDTO.
	 */
	// Metodo constructor  InconsistenciaCampoTurnoDTO
	public InconsistenciaCampoTurnoDTO() {
	 ...
	 *
	 * @param ai_inconsistenciaDto el nuevo valor para la propiedad inconsistencia
	 *                             DTO
	 */
	public void setIid_inconsistenciaDTO(InconsistenciaDTO ai_inconsistenciaDto) {
		this.iid_inconsistenciaDTO = ai_inconsistenciaDto;
	}
	 ...
	 *                                registral DTO
	 */
	public void setIcrd_circuloRegistralDTO(CirculoRegistralDTO acr_circuloRegistralDto) {
		this.icrd_circuloRegistralDTO = acr_circuloRegistralDto;
	}
